...
import rbs.mentoria.lojavirtual.enuns.StatusContaPagar;
...
public class ContaPagar implements Serializable {
	...
	public Date getDtVencimanto() {
		return dtVencimanto;
	}

	public void setDtVencimanto(Date dtVencimanto) {
		this.dtVencimanto = dtVencimanto;
	}
