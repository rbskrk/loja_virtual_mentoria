...
@SequenceGenerator(name = "venda_compra", sequenceName = "venda_compra", allocationSize = 1, initialValue = 1)
public class VendaCompraLojaVirtual implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "venda_compra")
	private Long Id;
	...
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "cupom_deconto_fk"))
